...
class VitDet3D(PreTrainedModel):
    ...
    # Compatibility with newer transformers versions that expect these fields.
    _tied_weights_keys = []
    _dynamic_tied_weights_keys = []

    @property
    def all_tied_weights_keys(self):
        static_keys = getattr(self, "_tied_weights_keys", []) or []
        dynamic_keys = getattr(self, "_dynamic_tied_weights_keys", []) or []
        return list(static_keys) + list(dynamic_keys)
